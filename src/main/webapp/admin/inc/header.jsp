...
<head>
    ...
    <link href="../../assets/images/cart.png" rel="icon">
</head>
<body>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownTwo">
                        ...
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/administrator/products?act=create">Add New model.User</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownThree">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/administrator/users?act=index">All Users</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/administrator/users?act=create">Add New User</a>
                    </div>
                </li>
            </ul>
